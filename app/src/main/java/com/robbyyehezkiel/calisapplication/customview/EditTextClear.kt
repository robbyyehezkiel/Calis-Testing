package com.robbyyehezkiel.calisapplication.customview
...
class EditTextClear : AppCompatEditText, View.OnTouchListener {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        context.apply {
            ...
            setTextColor(ContextCompat.getColor(this, R.color.firebase_amber))
            setHintTextColor(ContextCompat.getColor(this, R.color.firebase_amber))
        }
        isSingleLine = true
